...
1. **[Open the Actor on Apify](https://apify.com/mrbridge/todoist-ai-assistant?fpr=mrbridge)** and copy your [Todoist API token](https://todoist.com/app/settings/integrations/developer)
...
- **Apify Store**: [Todoist MCP Server](https://apify.com/mrbridge/todoist-ai-assistant?fpr=mrbridge)
